...
func TestPrometheusRecorder(t *testing.T) {
	tests := map[string]struct {
		...
		"Observing the duration in queue of events should record the metrics.": {
			...
			expMetrics: []string{
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.005"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.01"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.025"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.05"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.1"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.25"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="0.5"} 1`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="1"} 1`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="2.5"} 1`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="5"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="10"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="+Inf"} 2`,
				`kooper_controller_event_in_queue_duration_total_count{controller="ctrl1"} 2`,

				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.005"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.01"} 0`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.025"} 1`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.05"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.1"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.25"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="0.5"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="1"} 3`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="2.5"} 3`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="5"} 3`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="10"} 4`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl2",le="+Inf"} 4`,
				`kooper_controller_event_in_queue_duration_total_count{controller="ctrl2"} 4`,
			},
		},
		...
		"Observing the duration in queue of events should record the metrics (Custom buckets).": {
			...
			expMetrics: []string{
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="10"} 1`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="20"} 2`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="30"} 3`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="50"} 3`,
				`kooper_controller_event_in_queue_duration_total_bucket{controller="ctrl1",le="+Inf"} 5`,
				`kooper_controller_event_in_queue_duration_total_count{controller="ctrl1"} 5`,
			},
		},
